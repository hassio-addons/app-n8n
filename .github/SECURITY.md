...
[**Report a vulnerability**](https://github.com/hassio-addons/app-n8n/security/advisories/new)
...
- Issues in n8n itself; please report those directly to the
  [n8n project](https://github.com/n8n-io/n8n/security).
...
This security policy covers the n8n app in this repository: the app
